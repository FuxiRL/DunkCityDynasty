...
- **About the Human Data: All data is collected through crowdsourcing. We invited hundreds of players of DunkCity Dynasty with different summit levels through our Fuxi Youling Crowdsourcing platform. The invited players played several summit matches (a typical gameplay mode) on the devices we provided and their corresponding operational data during the game matches were recorded to form this dataset. Each player has signed a user privacy agreement with us and has agreed to allow the collected data to be used for research purposes.
